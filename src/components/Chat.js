import { BellIcon, 
    ChatIcon, EmojiHappyIcon, GiftIcon, HashtagIcon, 
    InboxIcon, PlusCircleIcon, QuestionMarkCircleIcon, 
    SearchIcon, UsersIcon } from '@heroicons/react/solid';
import React, { useRef } from 'react';
import { useAuthState } from 'react-firebase-hooks/auth';
import { useSelector } from 'react-redux';
import { selectChannelId, selectChannelName } from '../feautures/channelSlice';
...
const Chat = () => {
  ...
  <div className="flex flex-col h-screen" >
      ...
      justify-between space-x-5 border-b border-gray-800 
      p-4 -mt-1">
          ...
          <div className="flex space-x-3 " >
              ...
              <div className="flex bg-discord_chatHeaderInputBg text-xs p-1 rounded-md ">
                  ...
                  pl-1 placeholder-discord_chatHeaderIcon "
                  />
      ...
      <div className="flex items-center p-2.5 bg-discord_chatInputBg mx-5 mb-7 rounded-lg" >
          ...
          < form className="flex-grow" >
                ...
                focus:outline-none text-discord_chatInputText 
