      ...
      <>
        ...
        <div className="flex h-screen">
          <div className="flex flex-col space-y-3 bg-[#202225] p-3 min-w-max">
            ...
            <ServerIcon image="https://cdn.discordapp.com/icons/789490395298005052/2211b969de8152c53198f2ff890b3c33.png" />
            <ServerIcon image="https://cdn.discordapp.com/icons/423464391791476747/5e4d03e7e382c3303ca0c401226a3625.png" />
            <ServerIcon image="https://cdn.discordapp.com/icons/789490395298005052/2211b969de8152c53198f2ff890b3c33.png" />
            <ServerIcon image="https://cdn.discordapp.com/icons/423464391791476747/5e4d03e7e382c3303ca0c401226a3625.png" />
          ...
          <div className="bg-discord_channelsBg flex flex-col min-w-max">
            ...
            items-center justify-between border-b border-gray-800 p-4
             hover:bg-discord_serverNameHoverBg cursor-pointer">
              Official PAPA Server... <ChevronDownIcon className="h-5 ml-2  " />
            </h2>

            <div className="text-[#8e9297] flex-grow overflow-y-scroll
             scrollbar-hide">
            ...
            <div className="bg-[#292b2f] p-2 flex justify-between items-center space-x-8" >
              <div className="flex items-center space-x-1" >
                ...
                <h4 className="text-white text-xs font-medium ">
                  {user?.displayName}
                  <span className="text-[#b9bbbe] block" > #{user?.uid.substring(0,3)} </span>
                </h4>
              </div>
